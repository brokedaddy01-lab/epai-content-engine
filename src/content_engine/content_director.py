...
class ContentDirector:
    ...
    def __init__(self, registry):
        ...
        self.intelligence = registry.brain(
        ...
        self.optimization = registry.brain(
        ...
        self.production = registry.brain(
        ...
        self.publishing = registry.brain(
